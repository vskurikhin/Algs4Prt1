/*************************************************************************
 *  Compilation:  javac MergeXSrt.java
 *  Execution:    java MergeXSrt < input.txt
 ...
 *
 *  % java MergeXSrt < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java MergeXSrt < words3.txt
...
/**
 *  The <tt>MergeXSrt</tt> class provides static methods for sorting an
