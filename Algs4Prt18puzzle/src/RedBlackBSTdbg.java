/*************************************************************************
 *  Compilation:  javac RedBlackBSTdbg.java
 *  Execution:    java RedBlackBSTdbg < input.txt
 ...
 *  
 *  % java RedBlackBSTdbg < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
...
public class RedBlackBSTdbg<Key extends Comparable<Key>, Value> {
    ...
    *************************************************************************/
    ...
    // value associated with the given key; null if no such key
    public boolean getColor(Key key) { return getColor(root, key); }
    ...
    public void setTraversal(int t) { traversal = t; }
    ...
    // value associated with the given key in subtree rooted at x; null if no such key
    private int getLevel(Node x, Key key) {
        while (x != null) {
            int cmp = key.compareTo(x.key);
            if      (cmp < 0) x = x.left;
            else if (cmp > 0) x = x.right;
            else              return x.level = traversal;
            traversal++;
        }
        return -1;
    }
